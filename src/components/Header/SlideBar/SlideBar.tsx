...
import SidebarChildMenu from './SidebarChildMenu/SidebarChildMenu';
...
const SlideBar = ({ toggleMobileMenu, closeMobileMenu }: SlideBarProps) => {
  ...
  return (
    <>
      <div
        className={`transition duration-1000 lg:hidden nav-menu--is-open js-mobile-menu dark:bg-jacarta-800 invisible fixed inset-0 z-20 ml-auto items-center bg-white opacity-0 lg:visible lg:relative lg:inset-auto lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent ${
        ...
        <nav className='navbar w-full'>
          <ul className='flex flex-col lg:flex-row'>
              ...
              <Link to='/'>
                <div>
                  <button className='text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5'>
                    <span className={isChildrenPageActive('/', pathname) ? 'text-accent dark:text-accent' : ''}>
                      Home{' '}
                    </span>
                  </button>
                </div>
            ...
            <li className='js-nav-dropdown group relative'>
              ...
              <SidebarChildMenu childMenu={page} isCollapse={isCollapse} />
            </li>
            <li className='js-nav-dropdown nav-item dropdown group relative'>
              ...
              <SidebarChildMenu childMenu={explore} isCollapse={isCollapse} />
            </li>
            <li className='js-nav-dropdown group relative'>
              <button
              ...
              <SidebarChildMenu childMenu={resource} isCollapse={isCollapse} />
            </li>
            <li className='group'>
              <Link to='/create'>
                <div>
                  <button className='text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5'>
                    <span className={isChildrenPageActive('/create', pathname) ? 'text-accent dark:text-accent' : ''}>
                      Create
                    </span>
                  </button>
                </div>
