          ...
          >
            ...
            <div className='dropdown'>
              ...
              >
                <Link
                  to={''}
                  className='dropdown-item flex items-center justify-between rounded-xl px-5 py-2 font-display text-sm font-semibold text-jacarta-700 transition-colors hover:bg-jacarta-50 dark:text-white dark:hover:bg-jacarta-600'
                >
                  <span>English</span>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                ...
                <Link
                  to={''}
                  className='dropdown-item flex items-center justify-between rounded-xl px-5 py-2 font-display text-sm font-semibold transition-colors hover:bg-jacarta-50 dark:text-white dark:hover:bg-jacarta-600'
                >
                  <span>Español</span>
                </Link>
                <Link
